...
public class Level9Task {
    ...
    public static int[][] splitEvenOdd(int[] numbers) {
        ...
        for (int index = 0; index < oddCount; index++) {
            oddNumbers[index] = oddTemp[index];
     }

        for (int index = 0; index < evenCount; index++) {
            evenNumbers[index] = evenTemp[index];
        }
    ...
    public static int[] perfectSquares(int[] numbers) {
        ...
        for (int number : numbers) {
            ...
            for (int value = 0; value * value <= number; value++) {
    ...
    public static int[] replaceNonSquares(int[] numbers) {
        for (int index = 0; index < numbers.length; index++) {
            ...
            for (int value = 0; value * value <= numbers[index]; value++) {
